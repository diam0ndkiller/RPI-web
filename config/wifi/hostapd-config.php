		...
		<div style="border: 2px solid #ff0000; margin: 30px; margin-top: 75px">
			<div style="margin: 30px;" style="margin: 30px;">
				<table width="100%">
					<tr>
						<td width="*">
							<h1 class="title" style="color: <?php echo $accent_color;?>;"><tt>hostapd.conf</tt> - RPI</h1>
							<p class="subtitle">hostapd is the wifi acces point server on the Raspberry Pi.</p>
						</td>
				...
				<h5 class="title" style="font-size:28px; margin: 0px;">Configuration file for <tt>hostapd</tt>:</h5>
				<table width="100%">
					<tr>
						<td style="text-align: right">
							<?php
								if(isset($_POST['reset'])) {
									...
									echo "<p class='content' style='color: #00aa00; margin: 0px;'>Reset <tt>hostapd.conf</tt></p>";
								}
									...
									echo "<p class='content' style='color: #00aa00; margin: 0px;'>Saved <tt>hostapd.conf</tt></p>";
								}
							?>
						</td>
						<td width="*"></td>
