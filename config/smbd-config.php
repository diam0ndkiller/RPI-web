		...
		<div style="border: 2px solid #ff0000; margin: 30px; margin-top: 75px">
			<div style="margin: 30px;" style="margin: 30px;">
				<table width="100%">
					<tr>
						<td width="*">
							<h1 class="title" style="color: <?php echo $accent_color;?>;"><tt>smb.conf</tt> - RPI</h1>
							<p class="subtitle">Samba is the File server on the Raspberry Pi.</p>
						</td>
				...
				<h5 class="title" style="font-size:28px; margin: 0px;">Configuration file for <tt>smbd</tt>:</h5>
				<table width="100%">
					<tr>
						<td style="text-align: right">
							<?php
								if(isset($_POST['reset'])) {
									...
									echo "<p class='content' style='color: #00aa00; margin: 0px;'>Reset <tt>smb.conf</tt></p>";
								}
									...
									echo "<p class='content' style='color: #00aa00; margin: 0px;'>Saved <tt>smb.conf</tt></p>";
								}
							?>
						</td>
						<td width="*"></td>
					...
					<tr>
						<td width="100px" style="text-align: right;">
							<form method="post">
								<input type="submit" value="Restart smbd " name="restart" id="restart">
							</form>
							<?php
