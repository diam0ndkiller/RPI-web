...
<html>
	...
	<body>
		...
		<div style="border: 2px solid <?php echo $accent_color;?>; margin: 30px; margin-top: 75px">
			<div style="margin: 30px;" style="margin: 30px;">
				<table width="100%">
					<tr>
						<td width="*">
							<h1 class="title" style="color: <?php echo $accent_color;?>;"><tt>apache2.conf</tt> - RPI</h1>
							<p class="subtitle">Apache is the HTTP web server on the Raspberry Pi.</p>
						</td>
				...
				<h5 class="title" style="font-size:28px; margin: 0px;">Configuration file for <tt>apache2</tt>:</h5>
				<table width="100%">
					<tr>
						<td style="text-align: right">
							<?php
								if(isset($_POST['reset'])) {
									...
									echo "<p class='content' style='color: #00aa00; margin: 0px;'>Reset <tt>apache2.conf</tt></p>";
								}
									...
									echo "<p class='content' style='color: #00aa00; margin: 0px;'>Saved <tt>apache2.conf</tt></p>";
								}
							?>
						</td>
						<td width="*"></td>
					...
					<tr>
						<td width="100px" style="text-align: right;">
							<form method="post">
								<input type="submit" value="Restart apache2" name="restart" id="restart">
							</form>
							<?php
